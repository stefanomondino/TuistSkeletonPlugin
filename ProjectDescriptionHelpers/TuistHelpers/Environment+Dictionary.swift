...
public indirect enum DictionaryValue: Codable, Equatable, Sendable {
...
extension Optional where Wrapped == ProjectDescription.Environment.Value {
    public func getString(fallback: ProjectDescription.Environment.Value?,
                          default defaultString: String) -> String {
        getString(default: fallback.getString(default: defaultString))
